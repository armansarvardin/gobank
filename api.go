...
func (s *APIServer) handleLogin(w http.ResponseWriter, r *http.Request) error {
	...
	acc, err := s.store.GetAccountByNumber(request.Number)

	if err != nil {
		return WriteJSON(w, http.StatusInternalServerError, &ApiError {Error: "Account not found"})
	}
